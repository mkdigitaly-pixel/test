# Tilda — блок «Где меня читать» (подвал / отдельный блок)
...
Цифры из реальных проектов: как снижали CPL, настраивали Директ и дорабатывали сайты. Без воды — только практика.

## Ссылки (иконки или текст)
...
Бесплатный разбор рекламы → [mkekspert.ru/razbor-direct](https://mkekspert.ru/razbor-direct)

---

## HTML для Tilda (если блок T123 / код)
